...
// type DisplayElementSwitchProps = Partial<DisplayElementSwitch>;

interface DisplayElementSwitchProps {
...
type ShowOptions = DisplayElementSwitchProps & {[prop:string]:any};
...
type GetOffset = (showOptions:ShowOptions,container:HTMLDivElement,displayElementSwitch:DisplayElementSwitch)=>OffsetStyle|null|undefined

type Ele = string | Element;
type EleOpts = Ele | Ele[];

type UpdateOptions = (showOptions:ShowOptions,container:HTMLDivElement,displayElementSwitch:DisplayElementSwitch)=>void;
...
export default class DisplayElementSwitch {
     ...
     */
    constructor(props?:DisplayElementSwitchProps);
